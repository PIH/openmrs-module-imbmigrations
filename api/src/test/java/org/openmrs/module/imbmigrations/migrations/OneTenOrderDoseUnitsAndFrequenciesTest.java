...
public class OneTenOrderDoseUnitsAndFrequenciesTest extends BaseModuleContextSensitiveTest {
	
	private ConceptService conceptService = null;
	
	private OneTenOrderDoseUnitsAndFrequencies prepareInstance = null;
	
	@Before
	public void setupDatabase() throws Exception {
		conceptService = Context.getConceptService();
		prepareInstance = new OneTenOrderDoseUnitsAndFrequencies();
		
		executeDataSet("Concept-More-data.xml");
	}
	
	/**
	 * @see {@link OneTenOrderDoseUnitsAndFrequencies#addConceptSetMember(String, Concept)}
	 */
	@Test
	...
	/**
	 * @see {@link OneTenOrderDoseUnitsAndFrequencies#createConcept(String, String, boolean)}
	 */
	@Test
	...
	/**
	 * @see {@link OneTenOrderDoseUnitsAndFrequencies#addDoseUnitOrFrequencyEntryToSettingFileContent(String, Integer)}
	 */
	@Test
